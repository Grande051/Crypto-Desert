...
// Uses a smoothed power curve: XP(n) = floor(80 * n^1.65)
// Progression: Lv1→2: 80xp | Lv5→6: 1138xp | Lv10→11: 3573xp | Lv20→21: 11214xp
func XPToNextLevel(level int) int {
	return int(80.0 * math.Pow(float64(level), 1.65))
}
